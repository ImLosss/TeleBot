...
async function dlvs(bot, msg, value, config) {
    ...
    exec(`yt-dlp -J --no-warnings --no-call-home --no-check-certificate --cookies-from-browser firefox -F "${url}"`, { maxBuffer: 1024 * 1024 * 200 }, (error, stdout, stderr) => {
        if (error) {
